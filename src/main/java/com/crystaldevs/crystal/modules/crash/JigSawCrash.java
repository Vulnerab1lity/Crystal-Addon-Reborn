...
public class JigSawCrash extends Module {
    ...
    public JigSawCrash() {
        super(CrystalAddon.CRYSTAL_CRASH_CATEGORY.get(), "Jigsaw Crash", "CRYSTAL || Want to play a game? Attempts to crash the server you are on by using JigSaw update packets.");
