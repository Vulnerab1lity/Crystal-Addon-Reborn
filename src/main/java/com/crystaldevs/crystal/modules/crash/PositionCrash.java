...
public class PositionCrash extends Module {
    ...
    public PositionCrash() {
        super(CrystalAddon.CRYSTAL_CRASH_CATEGORY.get(), "Position Crash", "CRYSTAL || Attempts to crash the server you are connected to bny sending broken position packets.");
