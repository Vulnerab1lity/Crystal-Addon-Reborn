...
import static meteordevelopment.meteorclient.commands.Commands.*;
...
public class SetBlockCommand extends Command {
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        LiteralArgumentBuilder<CommandSource> then = builder.then(argument("block", BlockStateArgumentType.blockState(REGISTRY_ACCESS)).executes(ctx -> {
        ...
        }).then(argument("pos", ClientPosArgumentType.pos())));
    }
}
