...
public class SetVelocityCommand extends Command {
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        LiteralArgumentBuilder<CommandSource> then = builder.then(argument("y", DoubleArgumentType.doubleArg()).executes(ctx -> {
        ...
        LiteralArgumentBuilder<CommandSource> then1 = builder.then(argument("x", DoubleArgumentType.doubleArg()).then(argument("z", DoubleArgumentType.doubleArg()).executes(ctx -> {
